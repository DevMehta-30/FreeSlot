            ...
            for j in range(len(finalboxes[i])):
                ...
                if(len(finalboxes[i][j])==0):
                    ...
                    for k in range(len(finalboxes[i][j])):
                        ...
                        # image2 = cv2.imread("finalimg.jpg", 0)
                        # hsv_color1 = np.asarray([0, 200, 255])   # white!
                        # hsv_color2 = np.asarray([200, 250, 255]) 
                        # if cv2.inRange(image2, hsv_color1, hsv_color2)==True:
                        #     inner = inner +"NO"
                        # else:
                        #     inner = inner + "YES"
                        ...
                        # if(len(out)==0):
                        #     out = pytesseract.image_to_string(finalimg, config='--psm 3')
